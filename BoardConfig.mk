...
# Use fixed sizes for dynamic partitions to avoid non-linear mapping
BOARD_ODMIMAGE_PARTITION_SIZE := 268435456 # 256 MiB
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 3221225472 # 3 GiB
BOARD_SYSTEM_EXTIMAGE_PARTITION_SIZE := 1073741824 # 1 GiB
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2147483648 # 2 GiB
